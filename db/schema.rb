...
ActiveRecord::Schema.define(version: 20170701075733) do
  ...
  create_table "articles_categories", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
